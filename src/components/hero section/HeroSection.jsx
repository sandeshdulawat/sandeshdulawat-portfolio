...
function HeroSection() {
  return (
    <div className="bg-[#111827] ">
      <div className="max-w-screen-lg md:max-w-screen-xl mx-auto w-full h-full px-8 py-16 md:py-32 flex flex-col-reverse sm:flex-row sm:justify-between md:flex-row md:justify-between text-white items-center">
        <div className="space-y-2 sm:space-y-2 md:space-y-5">
          ...
          I specialize in crafting stunning websites for your business, bringing a wealth of experience in <br/> web design and development. With a keen eye for detail and a commitment to excellence, I ensure that <br/> your online presence not only looks impressive but also functions <br/> seamlessly to enhance your brand.
          </h3>
